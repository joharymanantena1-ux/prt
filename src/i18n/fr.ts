...
export const fr = {
  ...
  hero: {
    ...
    lead: "Je conçois et développe des applications web et mobile, de l'architecture backend jusqu'à l'interface finale.",
  ...
  about: {
    label: "À propos",
    title: "Qui suis-je ?",
    desc: "Développeur full-stack, je construis des applications web et mobile de bout en bout, du modèle de données à l'interface finale.",
